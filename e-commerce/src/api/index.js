export  const arrayDeSapatos = [
    ...
    {id:4, modelo: 'New Balance 990', tipo: 'Esportivo', valor: 229.99 , categoria:'d', quantidade:10, descricao:"xxxxxxxx xxxxxxxxxxxxxxx ccxxxxxxxxxxxx xxxxxxxxxxxx xxxxxxxxxxxxx xxxxxxxxxxxxxxxxxxxxxxxxxxxxx x x x x x  xxx x x xxxxxxx xxxxx xxxxxxx xxxxxx xxxxxx x" },
    ...
    {id:11,modelo: 'Merrell Moab 2', tipo: 'Trilha', valor: 139.99 , categoria:'e', quantidade:10, descricao:"xxxxxxxx  x x x x x  xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx x x xxxxxxx xxxxx xxxxxxx xxxxxx xxxxxx x" },
