  ...
  return (
    <main className="flex flex-col md:flex-row relative items-center   font-Inter text-base ">
      <section className="h-3/4  md:h-screen md:w-1/2  md:bg-slate-100 absolute md:relative mt-20 md:mt-0   flex items-center justify-center">
        <div className="flex flex-col items-center bg-white gap-4 p-3  min-w-[315px] md:w-[31vw]">
          <form
            action=""
          ...
          >
            ...
            <label className="flex flex-col font-semibold ">
              ...
              <input
                ...
                name="email"
                className="bg-slate-100 px-2 h-10 min-w-[230px] rounded-lg md:w-[23vw] font-medium placeholder-stone-500"
              />
            </label>
            <label className="flex flex-col font-semibold ">
              Senha:*
            ...
            <button
              type="submit"
              className="bg-laranja text-white rounded-lg h-14 min-w-[230px] max-w-[350px] mx-auto md:w-[23vw] px-5  "
              onClick={handleLogin}
            >
              Fazer Login
            </button>
